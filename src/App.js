    ...
    <div className='App'>
      <div className='App-container'>
        ...
        <div className='Rating-container'>
          ...
          <p className='Category-text'>Age Range</p>
          <p className='Category-subtext'>Choose <b>one</b></p>
          <ButtonSelectAge />
          <p className='Category-text'>Bought For</p>
          <p className='Category-subtext'>Choose <b>one</b> </p>
          <ButtonSelectGift />
          <p className='Category-text'>Country</p>
